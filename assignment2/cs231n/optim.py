...
def sgd_momentum(w, dw, config=None):
    ...
    """
    if config is None: config = {}
    config.setdefault('learning_rate', 1.8e-2)
    ...
    # 吴恩达方式（相对来说较为低效 https://www.quora.com/What-is-the-difference-between-these-two-implementations-of-momentum-for-a-gradient-descent?force_dialog=1）
